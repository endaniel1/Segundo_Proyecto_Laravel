...
@section("Info_Conte","Editar Categoria ". $categories->name)
...
@section("content")
	...
	{!! Form::open(["route"=>['categories.update', $categories],"method"=>"PUT","class"=>"form-horizontal"])!!}
		...
		<table width="50%" border="0" align="center" cellpadding="5" cellspacing="5">
			<tr>
  				...
  				<td>
  					{!! Form::text("name",$categories->name,["class"=>"form-control","placeholder"=>"Nombre Completo","required","style"=>"width:80%;"])  !!}
  				</td>
  			</tr>
  			<tr>
				<td align="right">
